...
DB_CONTAINER="${DB_CONTAINER:-${MYSQL_CONTAINER_NAME:-fashionecom-mysql}}"
DB_NAME="${DB_NAME:-${MYSQL_DATABASE:-fashion_ecom}}"
DB_USER="${DB_USER:-${MYSQL_USER:-fashionecom}}"
LOG_FILE="${LOG_FILE:-/var/log/fashionecom/restore.log}"
ENV_FILE="${ENV_FILE:-/opt/fashionecom/.env}"
