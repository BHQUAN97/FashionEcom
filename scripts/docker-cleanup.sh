#!/bin/bash
# ──────────────────────────────────────────
# FashionEcom — Docker Cleanup Script
# Run via cron: 0 3 * * 0  /opt/fashionecom/scripts/docker-cleanup.sh (weekly Sunday 3am)
# ──────────────────────────────────────────

set -euo pipefail

LOG_FILE="/var/log/fashionecom/docker-cleanup.log"
